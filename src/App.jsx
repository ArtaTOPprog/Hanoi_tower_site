    ...
    <>
      <div className="app">
        <header className="header">
          ...
          <p className="subtitle">Рекурсивное и итеративное решение с пояснением на языке C</p>
        </header>
        ...
        <footer className="footer">
          <p>✨ Страница создана студентами KE-25-02 Муфахаровым Артуром и KA-25-06 Капаевым Семёном с любовью и в помощь вам ❤️</p>
        </footer>
      </div>
    </>
  )
